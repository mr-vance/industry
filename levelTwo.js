class levelTwo extends Phaser.Scene {
    ...
    create() {
        ...
        const levelText = this.add.bitmapText(centerX - 20, centerY - 100, 'arcadeFont', `Assembly industry: Storage devices needed.`, 7);
        ...
        this.update = function () {
            if (!correctAnswerGiven && timeLeft > 0) {
                ...
                if (timeLeft <= 0) {
                    ...
                    this.scene.start("levelTwoOver"); // You may want to go back to the main menu or a game over scene
                }
            }
        };
